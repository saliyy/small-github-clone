...
<template>
  <nav class="flex items-center justify-between flex-wrap bg-teal-700 p-6">
    <div class="flex items-center flex-shrink-0 text-white mr-6">
      ...
      <span class="font-semibold text-xl tracking-tight">Orders</span>
    </div>
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      <div class="text-sm lg:flex-grow">
        <a
          ...
          class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 text-lg"
        >
          My Orders
        </a>
        <a
        ...
        <a
          href="#responsive-header"
          class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white text-lg"
        >
          Blog
        </a>
      </div>
